...
func main() {
	...
	if prometheusAddr == "" {
		setupLog.Error(nil, "PROMETHEUS_ADDRESS environment variable must be set")
		os.Exit(1)
	}
	...
	if workersStr != "" {
		...
		if err != nil {
			setupLog.Error(err, "invalid CONTROLLER_WORKERS value")
			os.Exit(1)
		}
	}
	...
	mgr, err := ctrl.NewManager(ctrl.GetConfigOrDie(), ctrl.Options{
		...
		LeaderElectionID:       "vpa-controller-leader",
	})
	if err != nil {
	...
	promClient, err := prometheus.NewClient(prometheusAddr)
	if err != nil {
